...
Wakatime Leaderboards is **maintained by a single developer** ([@nicconike](https://x.com/Nicco_nike)) as an open-source GitHub Action. This security policy reflects the realities of solo project maintenance while maintaining security best practices.
...
|-----------------|----------------|---------|
| **Code Analysis** | CodeQL, Bandit, Pylint , SonarQube | ✅ Active |
...
- Go to the [Security tab](https://github.com/Nicconike/Wakatime-Leaderboards/security)
...
**❌ Out of Scope:**
- Issues in **Wakatime's API** itself (report to [Wakatime](https://wakatime.com/contact))
...
|---------|---------------|------------------|
| **≥ v1.2.3** | ✅ **Full support** | Keep updated with latest releases |
...
- **GitHub Security Features:** [Repository Security](https://github.com/Nicconike/Wakatime-Leaderboards/security)
- **OpenSSF Scorecard:** [Detailed Security Metrics](https://scorecard.dev/viewer/?uri=github.com/Nicconike/Wakatime-Leaderboards)
- **Docker Hub:** [Container Images](https://hub.docker.com/r/nicconike/wakatime-leaderboards)

***

## 🤝 Contact & Support

- **Security:** [github.giving328@passmail.com](mailto:github.giving328@passmail.com)
- **General Issues:** [GitHub Issues](https://github.com/Nicconike/Wakatime-Leaderboards/issues), Tag with `security` label
- **Discussions:** [GitHub Discussions](https://github.com/Nicconike/Wakatime-Leaderboards/discussions)

**Thank you for helping keep Wakatime Leaderboards and our community secure! 🙏**
